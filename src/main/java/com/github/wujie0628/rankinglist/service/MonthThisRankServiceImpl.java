 ...
 * @Description
 **/
public class MonthThisRankServiceImpl implements RankService{

    private RedisKey redisKey;
    @Autowired
    private RedisTemplate redisTemplate;

    public MonthThisRankServiceImpl(RedisKey redisKey, RedisTemplate redisTemplate) {
    ...
    public void putValue(String value, int delta) {
        ...
        //设置数据40天后过期
        redisTemplate.expire(redisKey.getUnitKey() + ":" + today, 40, TimeUnit.DAYS);
